...
<body>
  <div class="wrapper">
    ...
    <section id="detail-mv" style=" background: url(../../static/images/_29A5962.jpg) center center no-repeat; background-size: cover;">
        <div class="detail-mv-tx">
          <h3>博多/春吉<br>Mei Atrium</h3>
          <p>福岡県春吉2-16-19</p>
        </div>
    </section>
    ...
    <section id="roomDetailcontent">
        ...
        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/_29A5962.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/_29A5990.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/booking_2019_10_29_39.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/_29A5948.jpg'); ?>">
        </div>

        <div class="detailArrows">
            <a class="detail-prev" href="<?= base_url('statics/roomDetail4'); ?>">
              <img src="<?= base_url('static/images/down-arrow-5.png'); ?>">
              <p>前へ<br><span>博多/春吉</span></p>
            </a>

            <a class="detail-next" href="<?= base_url('statics/roomDetail6'); ?>">
