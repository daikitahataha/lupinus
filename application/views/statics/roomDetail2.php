...
<body>
  <div class="wrapper">
    ...
    <section id="detail-mv" style=" background: url(../../static/images/_29A6484.jpg) center center no-repeat; background-size: cover;">
        <div class="detail-mv-tx">
          <h3>博多/春吉<br>Mei Penthouse</h3>
          <p>福岡県春吉2-16-19</p>
        </div>
    </section>
    ...
    <section id="roomDetailcontent">
        ...
        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/_29A6467.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/booking_2019_10_29_241.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/booking_2019_10_29_242.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/booking_2019_10_29_244.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/booking_2019_10_29_245.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/_29A6457.jpg'); ?>">
        </div>
        ...
        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/_29A6484.jpg'); ?>">
        </div>

        <div class="detailArrows">
            <a class="detail-prev" href="<?= base_url('statics/roomDetailasakusa'); ?>">
              <img src="<?= base_url('static/images/down-arrow-5.png'); ?>">
              <p>前へ<br><span>東京/浅草</span></p>
            </a>

            <a class="detail-next" href="<?= base_url('statics/roomDetail3'); ?>">
              <p>次へ<br><span>博多/春吉</span></p>
