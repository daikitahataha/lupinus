...
<body>
  <div class="wrapper">
    ...
    <section id="roomDetailcontent">
        ...
        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/DSC_0578.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/DSC_0600.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/DSC_0621.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/DSC_0647.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/DSC_0653.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/DSC_0588.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/DSC_0632.jpg'); ?>">
        </div>

        <div class="detailArrows">
            <a class="detail-prev" href="<?= base_url('statics/roomDetail10'); ?>">
              <img src="<?= base_url('static/images/down-arrow-5.png'); ?>">
              <p>前へ<br><span>東京/入船</span></p>
            </a>

            <a class="detail-next" href="<?= base_url('statics/roomDetail2')  ?>">
