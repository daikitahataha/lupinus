  ...
  <div class="wrapper">
    ...
    <section id="about-mv">
        <div class="about-mv-tx">
            <h2>MISSION</h2>
            <p>
              「ユーザーが自分のライフスタイルに合わせてホテルを選べるようになる世界」
              <br>
              これがルピナスを運営する弊社が描いている世界観です。
              弊社はこれを、個性豊かなホテルを数多く作ることで実現したいと考えています。
    　　　　　　<br>
              <br>
              ユーザーのライフスタイルへのこだわりが強まり、ニーズが多様化する現代では、
              ホテル選びにおいても、画一的でないオリジナル性の高い宿泊施設が求められます。
              <br>
              <br>
              ...
              <div class="people-content-tx">
                  ...
                  <div class="people-content-tx-intro">
                    <p>
                      ...
                      その後、人材業・金融・不動産・EC・ブライダル等の業界でサービス設計、企画、開発、マーケと
