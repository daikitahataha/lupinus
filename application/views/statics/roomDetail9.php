...
<body>
  <div class="wrapper">
    ...
    <section id="detail-mv" style=" background: url(../../static/images/_E0A0539.jpg) center center no-repeat; background-size: cover;">
        <div class="detail-mv-tx">
          <h3>東京/入船<br>Vintage Junior Suite</h3>
          <p>東京都中央区入船2-10-7</p>
        </div>
    </section>
    ...
    <section id="roomDetailcontent">
        ...
        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/_E0A0284 2.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/_E0A0545.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/_E0A0216.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/_E0A0237.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/_E0A0242.jpg'); ?>">
        </div>

        <div class="roomDetailcontent-img">
          <img src="<?= base_url('static/images/_E0A0539.jpg'); ?>">
        </div>

        <div class="detailArrows">
            <a class="detail-prev" href="<?= base_url('statics/roomDetail8'); ?>">
              <img src="<?= base_url('static/images/down-arrow-5.png'); ?>">
              <p>前へ<br><span>博多/春吉</span></p>
            </a>

            <a class="detail-next" href="<?= base_url('statics/roomDetail10'); ?>">
              <p>次へ<br><span>東京/入船</span></p>
